    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ForeignKey(null=True, verbose_name='assigned to', default=None, blank=True, to=settings.TAIGA_USER_MODEL, related_name='tasks_assigned_to_me', on_delete=models.SET_NULL)),
                ...
                ('owner', models.ForeignKey(null=True, verbose_name='owner', default=None, blank=True, to=settings.TAIGA_USER_MODEL, related_name='owned_tasks', on_delete=models.SET_NULL)),
                ...
                ('watchers', models.ManyToManyField(null=True, blank=True, to=settings.TAIGA_USER_MODEL, verbose_name='watchers', related_name='tasks_task+')),
            ],
            options={
